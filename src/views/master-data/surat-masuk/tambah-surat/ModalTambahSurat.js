...
import HelperTambahSurat from "./HelperTambahSurat";
import AutoCompleteHelper from "./AutoCompleteHelper";
import * as NomorAgendaHelpers from './NomorAgendaHelper';
import * as KodeSuratHelper from './KodeSuratHelper';
import * as moment from "moment";
import Autocomplete from "@material-ui/lab/Autocomplete";
import { TextField, FormControl, InputLabel, Select, MenuItem } from "@material-ui/core";
import axios from "axios";

const ModalTambahSuratKomponent = ({GetDataUser}) => {
  ...
  const {Form, SetForm, Error, SetError, ValidasiTgl, ValidasiNomor, ValidasiKarakter} = HelperTambahSurat();
    ...
    <React.Fragment>
      ...
      <CModal size='lg' show={Modal} onClose={TogleModal} closeOnBackdrop={false} color="success">
        <CModalHeader closeButton>
          <CModalTitle>Tambah Data Surat Masuk</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CRow>
        ...
        <CModalFooter>
          <CButton type='submit' color={Form.asal_surat === '' || Form.nomor_surat === '' || kategori_surat === null || Form.perihal === ''  || Error.error_nomor_agenda || Error.error_tanggal ? 'danger' : 'success'}
                  disabled={
                    ButtonTambah ||
                    Form.asal_surat === '' || Form.nomor_surat === '' || kategori_surat === null || Form.perihal === '' || Error.error_nomor_agenda || Error.error_tanggal
                  }
                  onClick={CobaTambahSurat}
          >
            {ButtonTambah ? '...Loading' : 'Tambah Data'}
          </CButton>{' '}
